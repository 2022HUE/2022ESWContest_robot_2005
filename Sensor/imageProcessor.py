...
class ImageProccessor:
    ...
    def alphabet_center_check(self,rect_x):
        alphabet_center_ret = Stair.in_alphabet_center_check(self,rect_x)
        '''motion
        # T: 전진
        # LEFT: 왼쪽으로 이동
        # RIGHT: 오른쪽으로 이동
        '''
        return alphabet_center_ret
    
    def alphabet_size_calc(self, alphabet_area):
