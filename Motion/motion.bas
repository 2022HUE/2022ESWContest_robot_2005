...
>>>>>>> 601e172 (Add: Motion file Ï∂îÍ∞Ä)
=======

>>>>>>> 5f3e757 (Chore: ÏÉ§ÏÇ≠ÏÉ§ÏÇ≠ Î™®ÏÖò ÏàòÏ†ï)
    WAIT
    mode = 0
    RETURN
    '************************************************
...
>>>>>>> 555d29a (Chore: Ï†ÑÎ∞©ÌïòÌñ• ÏÑ∏Î∂ÄÏ†ÅÏúºÎ°ú Ï∂îÍ∞Ä)
...
»ƒ¡¯¡æ¡æ∞…¿Ω_3:
    ...
    ENDIF
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO »ƒ¡¯¡æ¡æ∞…¿Ω_3_stop
    ERX 4800,A, »ƒ¡¯¡æ¡æ∞…¿Ω_4
    IF A <> A_old THEN
»ƒ¡¯¡æ¡æ∞…¿Ω_3_stop:
...
»ƒ¡¯¡æ¡æ∞…¿Ω_6:
    ...
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO »ƒ¡¯¡æ¡æ∞…¿Ω_6_stop

    ERX 4800,A, »ƒ¡¯¡æ¡æ∞…¿Ω_1
    IF A <> A_old THEN  'GOTO »ƒ¡¯¡æ¡æ∞…¿Ω_∏ÿ√„
»ƒ¡¯¡æ¡æ∞…¿Ω_6_stop:
...
ø¿∏•¬ ø∑¿∏∑Œ70ø¨º”_loop:
    ...
    '  ERX 4800, A ,ø¿∏•¬ ø∑¿∏∑Œ70ø¨º”_loop
    '    IF A = A_OLD THEN  GOTO ø¿∏•¬ ø∑¿∏∑Œ70ø¨º”_loop
    'ø¿∏•¬ ø∑¿∏∑Œ70ø¨º”_stop:
    GOSUB ±‚∫ª¿⁄ºº2
...
øﬁ¬ ø∑¿∏∑Œ70ø¨º”_loop:
    ...
    '   ERX 4800, A ,øﬁ¬ ø∑¿∏∑Œ70ø¨º”_loop	
    '    IF A = A_OLD THEN  GOTO øﬁ¬ ø∑¿∏∑Œ70ø¨º”_loop
    'øﬁ¬ ø∑¿∏∑Œ70ø¨º”_stop:
...
πÆø≠±‚∞»±‚_2:
    ...
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO πÆø≠±‚∞»±‚_2_stop
...
πÆø≠±‚∞»±‚_5:
    ...
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO πÆø≠±‚∞»±‚_5_stop
...
πÆø≠±‚∞»±‚»ƒ¡¯_3:
    ...
    ENDIF
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO πÆø≠±‚∞»±‚»ƒ¡¯_3_stop
    ERX 4800,A, πÆø≠±‚∞»±‚»ƒ¡¯_4
    IF A <> A_old THEN
πÆø≠±‚∞»±‚»ƒ¡¯_3_stop:
        MOVE G6D,95,  85, 130, 100, 104
...
πÆø≠±‚∞»±‚»ƒ¡¯_6:
    ...
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO πÆø≠±‚∞»±‚»ƒ¡¯_6_stop

    ERX 4800,A, πÆø≠±‚∞»±‚»ƒ¡¯_1
    IF A <> A_old THEN  'GOTO πÆø≠±‚∞»±‚»ƒ¡¯_∏ÿ√„
πÆø≠±‚∞»±‚»ƒ¡¯_6_stop:
        MOVE G6A,95,  85, 130, 100, 104
        MOVE G6D,104,  77, 146,  93,  102
        WAIT
...
øﬁ¬ ≈œ45_LOOP:
    ...
    '    ENDIF
    '
    '    ERX 4800,A,øﬁ¬ ≈œ45_LOOP
    '    IF A_old = A THEN GOTO øﬁ¬ ≈œ45_LOOP
    '
    GOTO RX_EXIT
...
ø¿∏•¬ ≈œ45_LOOP:
    ...
    '    ENDIF
    '
    '    ERX 4800,A,ø¿∏•¬ ≈œ45_LOOP
    '    IF A_old = A THEN GOTO ø¿∏•¬ ≈œ45_LOOP
    '
    GOTO RX_EXIT
    '**********************************************
øﬁ¬ ≈œ60:
...
øﬁ¬ ≈œ60_LOOP:
    ...
    '        GOTO RX_EXIT
    '    ENDIF
    '    ERX 4800,A,øﬁ¬ ≈œ60_LOOP
    '    IF A_old = A THEN GOTO øﬁ¬ ≈œ60_LOOP
...
ø¿∏•¬ ≈œ60_LOOP:
    ...
    '        GOTO RX_EXIT
    '    ENDIF
    '    ERX 4800,A,ø¿∏•¬ ≈œ60_LOOP
    '    IF A_old = A THEN GOTO ø¿∏•¬ ≈œ60_LOOP
...
<<<<<<< HEAD
<<<<<<< HEAD
    SERVO 11,100	' ¿Ã∞≈ ∏”¿”? ø÷ ªÛ«œ¿Œµ• 11¿Ãæﬂ
=======
    SERVO 11,100	
>>>>>>> 601e172 (Add: Motion file Ï∂îÍ∞Ä)
=======
    SERVO 11,100	' ¿Ã∞≈ ∏”¿”? ø÷ ªÛ«œ¿Œµ• 11¿Ãæﬂ
>>>>>>> cbc020c (Feat: ÌöüÏàò_ÏÉ§ÏÇ≠ÏÉ§ÏÇ≠ Ï∂îÍ∞Ä)
    SPEED 5
    GOSUB ±‚∫ª¿⁄ºº
    GOTO MAIN
...
=======
    GOSUB SOUND_PLAY_CHK
>>>>>>> 2bc48b6 (Chore: ÏùåÏÑ± Í¥ÄÎ†® Î™®ÏÖò ÏàòÏ†ï)
    RETURN
...
=======
    GOTO RX_EXIT
>>>>>>> 93c16a2 (Chore: ÏßëÍ≥†Ï†ÑÏßÑ Ïò§Î•ò ÏàòÏ†ï)
    '*******************
<<<<<<< HEAD
πÆø≠∞Ì¡˝∞Ì¿¸¡¯:
    ∫∏«‡º”µµ = 8
...
>>>>>>> 601e172 (Add: Motion file Ï∂îÍ∞Ä)
=======
>>>>>>> 090d4a9 (Chore: Î¨∏Ïó¥Í≥† Îã¨Î¶¨Í∏∞ Î™®ÏÖò ÏÇ≠Ï†ú)
»Ωºˆ_¡˝∞Ì»ƒ¡¯:
    GOSUB All_motor_mode3
    ≥—æÓ¡¯»Æ¿Œ = 0
    ∫∏«‡COUNT = 0
...
πÆø≠∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_3:
    ...
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO πÆø≠∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_3_stop

    ERX 4800,A, πÆø≠∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_4
    IF A <> A_old THEN
πÆø≠∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_3_stop:
...
πÆø≠∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_6:
    ...
    ENDIF
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO πÆø≠∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_6_stop
    ERX 4800,A, πÆø≠∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_1
    IF A <> A_old THEN
πÆø≠∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_6_stop:
...
¡˝∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_3:
    ...
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO ¡˝∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_3_stop
...
¡˝∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_6:
    ...
    ENDIF
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO ¡˝∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_6_stop
    ERX 4800,A, ¡˝∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_1
    IF A <> A_old THEN
¡˝∞Ì¿¸¡¯¥ﬁ∏Æ±‚50_6_stop:
...
>>>>>>> 601e172 (Add: Motion file Ï∂îÍ∞Ä)
=======
>>>>>>> a915980 (Chore: ÏßëÍ≥†Ï†ÑÏßÑÎã¨Îã¨Î¶¨Í∏∞ Î™®ÏÖò ÏÇ≠Ï†ú)
»Ωºˆ_¡˝∞Ì»ƒ¡¯_1:
    MOVE G6D,104,  76, 147,  93,  102
    MOVE G6A,95,  95, 120, 95, 104
    MOVE G6B, 190, 10, 50
...
»Ωºˆ_¡˝∞Ì»ƒ¡¯_3:
    ...
    ENDIF
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO »Ωºˆ_¡˝∞Ì»ƒ¡¯_3_stop
    ERX 4800,A, »Ωºˆ_¡˝∞Ì»ƒ¡¯_4
    IF A <> A_old THEN
»Ωºˆ_¡˝∞Ì»ƒ¡¯_3_stop:
        MOVE G6D,95,  85, 130, 100, 104
        MOVE G6A,104,  77, 146,  93,  102
...
»Ωºˆ_¡˝∞Ì»ƒ¡¯_6:
    ...
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO »Ωºˆ_¡˝∞Ì»ƒ¡¯_6_stop

    ERX 4800,A, »Ωºˆ_¡˝∞Ì»ƒ¡¯_1
    IF A <> A_old THEN  'GOTO »Ωºˆ_¡˝∞Ì»ƒ¡¯_∏ÿ√„
»Ωºˆ_¡˝∞Ì»ƒ¡¯_6_stop:
        MOVE G6A,95,  85, 130, 100, 104
        MOVE G6D,104,  77, 146,  93,  102
        MOVE G6B, 190, 10, 50
...
ª˛ªËª˛ªË:
    ...
    ∫∏«‡COUNT = 0
    SPEED 13
    'HIGHSPEED∑Œ æ» «œ∏È µ⁄∑Œ ∞®... πÃƒ£≥¿Œ µÌ
    'HIGHSPEED SETON
    '..... ¿Ã∞≈ «œ∏È ¥Ÿ¿Ω ∏º«µÈ±Ó¡ˆ ¥Ÿ ∞≥ª°∂Û¡ˆ¥¬µ• ∫π±Õ∏¶ æÓ∂ª∞‘ «œ¥¬¡ˆ ∏∏£∞⁄¿Ω
...
»Ωºˆ_ª˛ªËª˛ªË2:
    ...
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO »Ωºˆ_ª˛ªËª˛ªË_2_stop

    ERX 4800,A, »Ωºˆ_ª˛ªËª˛ªË4
    IF A <> A_old THEN
»Ωºˆ_ª˛ªËª˛ªË_2_stop:
        MOVE G6D,104,  77, 147, 93, 100
        MOVE G6A,95,  95, 143,  94,  102
...
»Ωºˆ_ª˛ªËª˛ªË5:
    ...
    ∫∏«‡COUNT = ∫∏«‡COUNT + 1
    IF ∫∏«‡COUNT > ∫∏«‡»Ωºˆ THEN  GOTO »Ωºˆ_ª˛ªËª˛ªË5_stop

    ERX 4800,A, »Ωºˆ_ª˛ªËª˛ªË1
    IF A <> A_old THEN
»Ωºˆ_ª˛ªËª˛ªË5_stop:
        MOVE G6A,104,  77, 147, 93, 100
        MOVE G6D,95,  95, 143,  94,  102
...
=======
>>>>>>> f20e10f (Chore: Î™®ÏÖò ÌååÏùºÏóê Í≥ÑÎã® ÎÇ¥Î†§Í∞ÄÎäî Î™®ÏÖò Ï∂îÍ∞Ä)
∞Ë¥‹ø¿∏•πﬂ≥ª∏Æ±‚1cm:
...
>>>>>>> ae648b4 (Chore: ÏÉ§ÏÇ≠ÏÉ§ÏÇ≠ Î™®ÏÖò Í∞ë ÏàòÏ†ï (Îí§Î°ú Í∞ÄÎäî Î™®ÏÖò ÏÉÅÌÉú))
    '******************************************
...
=======
    'SPEED 5
>>>>>>> d2ab6ee (Chore: ÏÉ§ÏÇ≠ÏÉ§ÏÇ≠ Î™®ÏÖò ÏàòÏ†ï)
    GOSUB ª˛ªËª˛ªË
    'GOSUB π∞∞«¡˝±‚
>>>>>>> 5f3e757 (Chore: ÏÉ§ÏÇ≠ÏÉ§ÏÇ≠ Î™®ÏÖò ÏàòÏ†ï)
=======
...
=======
    GOSUB ª˛ªËª˛ªË
    'GOSUB π∞∞«¡˝±‚
>>>>>>> f330313 (Chore: stair_left_down Î¨¥Î¶é, Ìåî Î≤åÎ¶¨Îäî Í∞ÅÎèÑ ÏàòÏ†ï)
=======
    'GOSUB ª˛ªËª˛ªË
    GOSUB π∞∞«¡˝±‚
>>>>>>> 77312ab (Add: Ï¥¨ÏòÅ.bas Ï∂îÍ∞Ä)
