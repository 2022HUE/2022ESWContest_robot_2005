...
샤삭샤삭1: '왼발
    ...
    MOVE G6A,97,  77, 147,  93,  102
    MOVE G6B, 100
    MOVE G6C, 100
    WAIT
샤삭샤삭2:

    MOVE G6A,99,   75, 145, 97,  100
    ...
    IF A <> A_old THEN
샤삭샤삭_2_stop:
        MOVE G6D,97,  78, 135, 94, 104
        MOVE G6A,96,  78, 145,  92,  102
        MOVE G6C, 100
        MOVE G6B,100
        WAIT
        HIGHSPEED SETOFF
...
샤삭샤삭4: '오른발
    ...
    MOVE G6D,97,  77, 147,  93,  102
    MOVE G6C, 100
    MOVE G6B, 100
    WAIT

샤삭샤삭5:
    MOVE G6D,99,    75, 145, 97,  100
    ...
    IF A <> A_old THEN
샤삭샤삭5_stop:
        MOVE G6A,97,  78, 135, 94, 104
        MOVE G6D,96,  78, 145,  92,  102
        MOVE G6B, 100
        MOVE G6C,100
        WAIT
        HIGHSPEED SETOFF
